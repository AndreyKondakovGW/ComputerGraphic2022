...
class Icosahedron(Polyhedron):
    ...
    def create_faces(self):
        ...
        self.faces.append(Face3D([self.edges[0], self.edges[1], self.edges[5]], self.brush_color))
        ...
        self.faces.append(Face3D([self.edges[10], self.edges[11], self.edges[15]], self.brush_color))
        ...
        self.faces.append(Face3D([self.edges[20], self.edges[21], self.edges[17]], self.brush_color))
        self.faces.append(Face3D([self.edges[22], self.edges[23], self.edges[18]], self.brush_color))
        self.faces.append(Face3D([self.edges[24], self.edges[25], self.edges[19]], self.brush_color))
        self.faces.append(Face3D([self.edges[26], self.edges[27], self.edges[15]], self.brush_color))
        self.faces.append(Face3D([self.edges[28], self.edges[29], self.edges[16]], self.brush_color))
    ...
    def create_edges(self):
        ...
        self.edges.append(Line3D(self.points[0], self.points[8], self.brush_color))
        ...
        self.edges.append(Line3D(self.points[2], self.points[5], self.brush_color))
    ...
    def create_points(self):
        ...
        for i in range(5):
            ...
            self.points.append(self.center + Point(x, y, -self.size / 2))
        ...
        self.points.append(self.center + Point(0, 0, -3 * self.size / 2))
        self.points.append(self.center + Point(0, 0, 3 * self.size / 2))