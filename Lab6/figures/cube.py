...
class Cube(Polyhedron):
    ...
    def create_faces(self):
        self.faces = []
        #нижняя грань
        self.faces.append(Face3D([self.points[0], self.points[1], self.points[2], self.points[3]], self.brush_color))
        ...
        #верхняя грань
        self.faces.append(Face3D([self.points[4], self.points[5], self.points[6], self.points[7]], self.brush_color, False))
        ...
        #задняя грань x
        self.faces.append(Face3D([self.points[4], self.points[0], self.points[3], self.points[7]], self.brush_color))
        ...
        #задняя грань z
        self.faces.append(Face3D([self.points[5], self.points[1], self.points[0], self.points[4]], self.brush_color))
        ...
        #передняя грань x
        self.faces.append(Face3D([self.points[6], self.points[2], self.points[3], self.points[7]], self.brush_color, False))
        ...
        #передняя грань z
        self.faces.append(Face3D([self.points[5], self.points[1], self.points[2], self.points[6]], self.brush_color, False))
