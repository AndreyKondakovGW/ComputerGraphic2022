...
class Renderer:
    ...
    def draw_direction(self, p, direction, size = 50):
        ...
        direction = self.translate3D_point(direction)
    ...
    def draw_line(self, points, color=(0, 0, 0), thickness = 2):
        ...
        p1, p2 = self.canvas.draw_line((points[0].x, points[0].y), (points[1].x, points[1].y), color, thickness=thickness)
