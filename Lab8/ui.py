...
class UI8(UI7):
    ...
    def init_sidemenu_instruments(self):
        ...
        self.side_menu_controller.add_instrument("Colored Tetrahedron", 
            lambda: ColoredTetrahedron(Point(50,50,50), 100))

        colors = [(255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 0), (255, 0, 255), (0, 255, 255)]
        self.side_menu_controller.add_instrument("Colored Cube", 
            lambda: ColoredCube(Point(50,50,50), 100, colors))
